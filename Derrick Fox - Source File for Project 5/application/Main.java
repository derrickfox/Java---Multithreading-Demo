...
public class Main extends Application {
  ...
  public void start(Stage primaryStage) {       
    ...
    primaryStage.setTitle("RacecaR"); // Set the stage title
    ...
    car.setOnKeyPressed(e -> {
	  ...
	  // Create a thread to run the animation and then start the thread
	  Runnable runIT = new RunCar();
	  Thread thread1 = new Thread(runIT);
	  thread1.start();
  }
...
// A class to implement the runnable interface
